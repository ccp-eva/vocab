...
firt_1F <- mirt(firt_dat, 1, itemtype = "2PL",  guess = .25,technical = list(NCYCLES = 2000))
firt_2F <- mirt(firt_dat, 2, itemtype = "2PL",  guess = .25,technical = list(NCYCLES = 2000))
firt_3F <- mirt(firt_dat, 3, itemtype = "2PL",  guess = .25,technical = list(NCYCLES = 2000))
